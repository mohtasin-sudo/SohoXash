            ...
            <main class="space-y-3 px-4 py-4 pb-28">
                <section class="space-y-2.5">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="rounded-full border border-zinc-100 bg-zinc-50 px-2.5 py-1 text-[10px] font-semibold text-zinc-500">124 jobs live</span>
                    </div>
                    ...
                    <div class="flex gap-2 overflow-x-auto no-scrollbar">
                        ...
                        <button class="flex-none rounded-full border border-zinc-100 bg-zinc-50 px-3 py-1 text-[11px] font-semibold text-zinc-500">App Install</button>
                        <button class="flex-none rounded-full border border-zinc-100 bg-zinc-50 px-3 py-1 text-[11px] font-semibold text-zinc-500">Social</button>
                        <button class="flex-none rounded-full border border-zinc-100 bg-zinc-50 px-3 py-1 text-[11px] font-semibold text-zinc-500">Survey</button>
                        <button class="flex-none rounded-full border border-zinc-100 bg-zinc-50 px-3 py-1 text-[11px] font-semibold text-zinc-500">Review</button>
                    </div>
                </section>

                <section class="space-y-2.5">
                    <a href="{{ route('jobs.show', ['jobId' => 'JOB-1024']) }}" class="block rounded-2xl border border-zinc-100 bg-white p-4 transition-all hover:border-zinc-200 hover:shadow-sm">
                    ...
                    <a href="{{ route('jobs.show', ['jobId' => 'JOB-1018']) }}" class="block rounded-2xl border border-zinc-100 bg-white p-4 transition-all hover:border-zinc-200 hover:shadow-sm">
                        <div class="mb-2 flex items-start justify-between gap-2">
                            <div>
                    ...
                    <a href="{{ route('jobs.show', ['jobId' => 'JOB-1007']) }}" class="block rounded-2xl border border-zinc-100 bg-white p-4 transition-all hover:border-zinc-200 hover:shadow-sm">
                        <div class="mb-2 flex items-start justify-between gap-2">
                            <div>
